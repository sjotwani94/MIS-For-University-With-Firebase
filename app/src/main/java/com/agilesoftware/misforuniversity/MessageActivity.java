...
public class MessageActivity extends AppCompatActivity implements Spinner.OnItemSelectedListener{
    ...
    public void smsOnNumber(){
        long num=Long.parseLong(selectedContact.getText().toString());
        Intent smsint = new Intent(Intent.ACTION_VIEW);
        smsint.putExtra("address",num);
        smsint.putExtra("sms_body",composedMessage.getText().toString());
        smsint.setType("vnd.android-dir/mms-sms");
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        ((TextView) parent.getChildAt(0)).setTextAppearance(MessageActivity.this, R.style.fontForNotificationLandingPage);
        switch (parent.getId()){
                    ...
                    case 0:
                        ...
                        dbRef.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                callList.setOnItemSelectedListener(MessageActivity.this);
                            }
